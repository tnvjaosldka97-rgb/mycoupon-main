...
import { stores, coupons } from './drizzle/schema.js';
...
const sampleStores = [
  ...
  },
  {
    ...
    phone: '02-318-2388',
    coupon: { title: '케이크 2+1', discountType: 'gift', discountValue: 0 }
  },
  {
    name: '투썸플레이스 명동예술극장점',
    category: 'cafe',
  ...
  },
  {
    ...
    phone: '02-2266-0525',
    coupon: { title: '커피 1+1', discountType: 'gift', discountValue: 0 }
  },
  {
    name: '명동교자 본점',
    category: 'restaurant',
  ...
  },
  {
    ...
    phone: '02-318-2388',
    coupon: { title: '죽 2개 구매 시 1개 무료', discountType: 'gift', discountValue: 0 }
  },
  {
    name: '을지로 BBQ',
    category: 'restaurant',
...
async function addSampleCoupons() {
  ...
  for (const storeData of sampleStores) {
    ...
    console.log(`   ✅ 가게 등록 완료 (ID: ${store.id})`);
